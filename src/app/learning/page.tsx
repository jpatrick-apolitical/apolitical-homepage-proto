          ...
          <div className="grid md:grid-cols-[3fr_2.2fr] gap-8 md:gap-12 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.15] tracking-tight text-center md:text-left">
                Adaptive, AI-powered learning designed for the realities of public service
              </h1>
            </div>
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-3 md:order-2">
              ...
              <p className="text-gray-400 font-light text-base md:text-lg">
                With personalised and practical training designed to help public servants apply new skills in their day-to-day work.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[980px] mx-auto">
          ...
          <div className="flex flex-col md:hidden">
            <h2 className="text-2xl font-medium leading-tight mb-6">
              Designed for government roles
            </h2>
            <div className="mb-6">
              <ImageCarousel />
            </div>
            <p className="text-gray-400 font-light text-base mb-8">
              Learning reflects your specific public sector context, responsibilities, and constraints, not broad personas and generic workplaces.
            </p>
          </div>
      ...
      <section className="px-6 md:px-8 lg:px-12 pt-16 md:pt-24 pb-32 md:pb-48 border-t border-white/5">
        <div className="max-w-[980px] mx-auto">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            {/* Title - mobile only, shown first */}
            <h2 className="md:hidden text-2xl font-medium leading-tight order-1">
              Progress from understanding to confident use
            </h2>
            ...
            <div className="order-3 md:order-1">
              ...
              <p className="text-gray-400 font-light text-base md:text-lg">
                Public servants build skills they can safely and responsibly apply to policy, delivery, and decision-making.
              </p>
            </div>
          </div>
        </div>
