          ...
          <div className="grid md:grid-cols-[3fr_2.2fr] gap-8 md:gap-12 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.15] tracking-tight text-center md:text-left">
                Drive social impact through strategic partnership
              </h1>
            </div>
        ...
        <div className="max-w-[980px] mx-auto">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <h2 className="md:hidden text-2xl font-medium leading-tight order-1">
              Connect with government at scale
            </h2>
            ...
            <div className="order-3 md:order-2">
              ...
              <p className="text-gray-400 font-light text-base md:text-lg">
                Build meaningful relationships with public sector organisations worldwide through thought leadership, sponsorship, and strategic engagement.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[980px] mx-auto">
          ...
          <div className="flex flex-col md:hidden">
            ...
            <p className="text-gray-400 font-light text-base mb-8">
              Support public sector capability building as part of your environmental, social, and governance strategy with measurable, reportable outcomes.
            </p>
          </div>
        ...
        <div className="max-w-[980px] mx-auto">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-3 md:order-1">
              ...
              <p className="text-gray-400 font-light text-base md:text-lg">
                Contribute expertise and resources to help governments adopt technology responsibly, creating better outcomes for citizens and society.
              </p>
            </div>
          </div>
        </div>
