          ...
          <div className="grid md:grid-cols-[3fr_2.2fr] gap-8 md:gap-12 items-start">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-medium leading-[1.15] tracking-tight text-center md:text-left">
                Redesigning public institutions for the age of AI through people and technology
              </h1>
            </div>
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="order-3 md:order-2">
              ...
              <p className="text-gray-400 font-light text-base md:text-lg">
                Apolitical&apos;s flagship platform designed to close the gap between AI ambition and adoption. Futura helps governments to understand where AI will create value, what to prioritise and how to build new capabilities at workforce scale.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 md:px-8 lg:px-12 pt-16 md:pt-24 pb-32 md:pb-48 border-t border-white/5">
        <div className="max-w-[980px] mx-auto">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            {/* Title - mobile only, shown first */}
            <h2 className="md:hidden text-2xl font-medium leading-tight order-1">
              Futura is built around multiple pillars of transformation
            </h2>
            ...
            <div className="order-3 md:order-1">
              ...
              <p className="text-gray-400 font-light text-base md:text-lg">
                AI capability is a central pillar of Futura, alongside other key areas of public sector capability that together deliver transformation across teams, systems, and whole workforces.
              </p>
            </div>
          </div>
        </div>
